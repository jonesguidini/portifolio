...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = '../img/uploads/editor'; // Relative to domain name
	$config['project_path'] = '/PROJETOS/Dropbox/samaritanodf.org.br/admin/'; // <== quando for lançar ao ar comentar esta linha e...
	//$config['project_path'] = '/admin/'; //...descomentar estaq
	$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] . $config['project_path'] . $config['img_path']; // Physical path. [Usually works fine like this]
