...
<!-- /TinyMCE -->
		   ...
		   ?>
			...
			<form action="_ac_alterar_artigo.php" method="post" onsubmit="javascript: return valida_novo_artigo();" name="form_novo_artigo">
				<input type="hidden" name="id" value="<?php echo $id;?>">
			
				<div style="margin-bottom: 10px;"><b>Título:</b> <input type="text" name="titulo" style="width: 918px;" value="<?php echo $artigo->titulo;?>"></div>
			    <textarea id="artigo" name="artigo"><?php echo $artigo->artigo;?></textarea>
			    <br>
